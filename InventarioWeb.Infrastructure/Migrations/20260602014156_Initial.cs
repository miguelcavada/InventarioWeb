        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Descripcion = table.Column<string>(type: "varchar(500)", maxLength: 500, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Encargado = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrecioCostoAnterior = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    PrecioCostoNuevo = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    PrecioVentaAnterior = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    PrecioVentaNuevo = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Motivo = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    FechaCambio = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    UsuarioCambio = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    FechaCreacion = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    FechaModificacion = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    Activo = table.Column<bool>(type: "tinyint(1)", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Ubicacion = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    FechaCreacion = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    FechaModificacion = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    Activo = table.Column<bool>(type: "tinyint(1)", nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StockAlmacenes_Productos_ProductoId",
                        column: x => x.ProductoId,
                        principalTable: "Productos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, "ALM-CENTRAL", null, "Calle Principal #123", null, new DateTime(2026, 6, 1, 21, 41, 55, 718, DateTimeKind.Local).AddTicks(5511), null, "Almacén Central", null, "ALMACEN" },
                    { 2, true, "MER-NORTE", null, "Av. Norte #456", null, new DateTime(2026, 6, 1, 21, 41, 55, 718, DateTimeKind.Local).AddTicks(5527), null, "Mercado Norte", null, "MERCADO" },
                    { 3, true, "MER-SUR", null, "Av. Sur #789", null, new DateTime(2026, 6, 1, 21, 41, 55, 718, DateTimeKind.Local).AddTicks(5532), null, "Mercado Sur", null, "MERCADO" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, "Productos electrónicos", new DateTime(2026, 6, 1, 21, 41, 55, 718, DateTimeKind.Local).AddTicks(4966), null, "Electrónicos" },
                    { 2, true, "Muebles de oficina", new DateTime(2026, 6, 1, 21, 41, 55, 718, DateTimeKind.Local).AddTicks(4974), null, "Muebles" },
                    { 3, true, "Suministros de oficina", new DateTime(2026, 6, 1, 21, 41, 55, 718, DateTimeKind.Local).AddTicks(4981), null, "Suministros" }
                });

            migrationBuilder.InsertData(
                table: "Productos",
                columns: new[] { "Id", "Activo", "CategoriaId", "Codigo", "Descripcion", "FechaCreacion", "FechaModificacion", "Nombre", "PrecioCosto", "PrecioVenta" },
                values: new object[,]
                {
                    { 1, true, 1, "PROD-001", "Laptop HP 15 pulgadas", new DateTime(2026, 6, 1, 21, 41, 55, 718, DateTimeKind.Local).AddTicks(5396), null, "Laptop HP", 800.00m, 1200.00m },
                    { 2, true, 2, "PROD-002", "Escritorio ejecutivo", new DateTime(2026, 6, 1, 21, 41, 55, 718, DateTimeKind.Local).AddTicks(5405), null, "Escritorio", 300.00m, 500.00m }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Movimientos_NumeroDocumento",
                table: "Movimientos",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockAlmacenes_ProductoId_AlmacenId",
                table: "StockAlmacenes",
